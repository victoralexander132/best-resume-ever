  ...
  <div class="resume">
    ...
    <div class="rightCol">
      ...
      <div class="section-headline experience">
        <i class="material-icons" style="position: absolute; right: 10px;">work</i>
        {{ lang.experience }}
      </div>
      ...
      <div class="section-headline">
        <i class="material-icons" style="position: absolute; right: 10px;">code</i>
        {{ lang.projects }}
      </div>
      ...
      <div class="section-headline">
        <i class="material-icons" style="position: absolute; right: 10px;">school</i>
        {{ lang.education }}
      </div>
